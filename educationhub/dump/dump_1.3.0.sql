...
-- Дамп данных таблицы edecationhub.users: ~3 rows (приблизительно)
...
INSERT INTO `users` (`id`, `role_id`, `status`, `username`, `password`, `first_name`, `last_name`, `phone`, `country_id`, `institute_name`, `sub_domen`) VALUES
	...
	(20, 2, 1, 'ost.vas1@mail.ru', 'fc2009efddf2a518b6eb03b31b99f83281711083b126f94beb95573847267540', 'Василь', 'Остапчук', '', 0, '', 'ed1');
