...
INSERT INTO `settings` (`id`, `name`, `value`) VALUES
	(1, 'WEBSITE', 'http://localhost/educationhub'),
	(2, 'PAYPAL_API_USERNAME', 'ost.vas-facilitator_api1.mail.ru'),
	(3, 'PAYPAL_API_PASSWORD', 'BBDDL7BZ6KBXTP53'),
	(4, 'PAYPAL_API_SIGNATURE', 'AYhHiveyvrMF4dOc0TjscYVilpzmA7SkRu7ArUqOv9VHPVuLcU.CB6vY'),
	(5, 'AUTHORIZENET_ENABLED', '1'),
	(6, 'AUTHORIZENET_API_URL', 'https://test.authorize.net/gateway/transact.dll'),
	(7, 'AUTHORIZENET_API_LOGIN', NULL),
	(8, 'AUTHORIZENET_API_TRANSACTION_KEY', NULL);
...
-- Дамп данных таблицы edecationhub.tariffs: ~4 rows (приблизительно)
...
INSERT INTO `users` (`id`, `role_id`, `status`, `username`, `password`, `first_name`, `last_name`, `phone`, `country_id`, `institute_name`, `sub_domen`) VALUES
	...
	(12, 2, 1, 'ost.vas@mail.ru', 'd5dcf51903d738183fdf2865b15f1a3ae8daa8735b15caad0469de57a03b3fcf', 'Administrator', 'Admin', '42378904723', 3, '', 'school'),
	(13, 2, 1, 'ost.vas4@mail.ru', 'ccd43cf912d4c80913b0008f55334f52108270173f921c765c0f8409131ddf33', '1', '2', '', 0, '', 'r444');
