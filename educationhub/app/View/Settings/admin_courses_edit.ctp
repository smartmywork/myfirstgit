...
<div class="row">
        <div class="col-md-12">
            <div class="page-header" style="margin: -30px 0 20px;">
                <h2><?php echo __('Edit course -"'.$this->Form->value('Course.name').'"'); ?></h2>
            </div>
        </div>
    </div>
<div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>
                            <?php
                             echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span> &nbsp;&nbsp;Delete', array('controller'=>'settings','action' => 'courses_delete',$this->Form->value('Course.id')), array('escape' => false,'title'=>'Delete'),__("Are you sure you want to delete\n%s?", $this->Form->value('Course.name')));
                             ?>
                        </li>
                    </ul>
                </div><!-- end body -->
