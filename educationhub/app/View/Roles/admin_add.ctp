    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header" style="margin: -30px 0 20px;">
                <h2><?php echo __('Add new role'); ?></h2>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                <?php echo $this->Form->input('name', array('class' => 'form-control', 'placeholder' => 'write a name role','label'=>'Name'));?>
            </div>
            ...
            <div class="form-group" style="padding-left: 20px;">
                <?php echo $this->Form->input('admin', array('class' => false, 'type'=>'checkbox','value'=>1));?>
            </div>

            <div class="form-group" style="padding-left: 20px;">
                <?php echo $this->Form->input('user', array('class' => false, 'type'=>'checkbox','value'=>1));?>
            </div>
